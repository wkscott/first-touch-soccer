...
const VICTORY_BRUSH_CONTAINER_DEFAULT_PROPS = {
  ...
  allowDraw: true,
  allowResize: true,
  brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__.Rect, null),
  brushStyle: {
    stroke: "transparent",
    fill: "black",
    fillOpacity: 0.1
  },
  handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__.Rect, null),
  handleStyle: {
    stroke: "transparent",
    fill: "transparent"
  },
...
const useVictoryBrushContainer = initialProps => {
  ...
  const getSelectBox = coordinates => {
    ...
    return x[0] !== x[1] && y[0] !== y[1] ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(brushComponent, {
      key: `${name}-brush`,
      ...
      y: Math.min(y[0], y[1]),
      cursor,
      style: lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, brushComponentStyle, brushStyle)
    }) : null;
  };
  ...
  const getHandles = domain => {
    ...
    const style = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, handleComponentStyle, handleStyle);
    ...
    const handles = ["top", "bottom", "left", "right"].reduce((memo, curr) => handleProps[curr] ? memo.concat( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(handleComponent, Object.assign({
  ...
  const getRect = () => {
    ...
    const brushDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, props.brushDomain, props.domain);
    const domain = react_fast_compare__WEBPACK_IMPORTED_MODULE_2___default()(brushDomain, cachedBrushDomain) ? lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, currentDomain, brushDomain) : brushDomain;
  ...
  return {
    props,
    children: [...react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(children), ...getRect()]
  };
};
const VictoryBrushContainer = initialProps => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.VictoryContainer, props, children);
};
...
/* harmony import */ var _victory_primitives_clip_path__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../victory-primitives/clip-path */ "../../victory-core/es/victory-primitives/clip-path.js");
/* harmony import */ var _victory_primitives_circle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../victory-primitives/circle */ "../../victory-core/es/victory-primitives/circle.js");
/* harmony import */ var _victory_primitives_rect__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../victory-primitives/rect */ "../../victory-core/es/victory-primitives/rect.js");
...
const defaultProps = {
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_line__WEBPACK_IMPORTED_MODULE_3__.Line, null),
  role: "presentation",
  shapeRendering: "auto"
};
  ...
  const findAxes = children => {
    return children.reduce((memo, child) => {
      if (child.type && child.type.role === "axis" && predicateFunction(child)) {
        ...
        return memo.concat(findAxes(react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(child.props.children)));
      }
      return memo;
    }, []);
  };
  ...
  const findComponents = children => {
    return children.reduce((memo, child) => {
      if (child.type && child.type.role === "axis" && matchesType(child)) {
        ...
        const childAxis = findComponents(react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(child.props.children));
...
function getDefaultTickFormat(props) {
  ...
  const tickValueArray = lodash_orderBy__WEBPACK_IMPORTED_MODULE_4___default()(Object.values(stringMap), n => n);
...
function getTickArray(props) {
  ...
  const tickArray = ticks ? lodash_uniq__WEBPACK_IMPORTED_MODULE_3___default()(ticks) : getTicksFromFormat();
    ...
    if (arr) {
      arr.forEach((t, index) => {
        if (Array.isArray(domain)) {
          if (t >= _collection__WEBPACK_IMPORTED_MODULE_5__.getMinValue(domain).valueOf() && t <= _collection__WEBPACK_IMPORTED_MODULE_5__.getMaxValue(domain).valueOf()) {
            newTickArray.push({
              value: t,
              index
            });
...
function modifyProps(props, fallbackProps) {
  ...
  const axisTheme = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, props.theme[role], props.theme.axis);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash_isDate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/isDate */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isDate.js");
...
function getMaxFromProps(props, axis) {
  ...
  return typeof props.maxDomain === "number" || lodash_isDate__WEBPACK_IMPORTED_MODULE_1___default()(props.maxDomain) ? props.maxDomain : undefined;
}
...
function getMinFromProps(props, axis) {
  ...
  return typeof props.minDomain === "number" || lodash_isDate__WEBPACK_IMPORTED_MODULE_1___default()(props.minDomain) ? props.minDomain : undefined;
}
...
function getSymmetricDomain(domain, values) {
  const processedData = lodash_sortedUniq__WEBPACK_IMPORTED_MODULE_3___default()(values.sort((a, b) => a - b));
...
/* harmony import */ var lodash_pickBy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/pickBy */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/pickBy.js");
...
/* harmony import */ var lodash_omitBy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/omitBy */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/omitBy.js");
...
function getScopedEvents(events, namespace, childType, baseProps) {
  ...
  const onEvent = (evt, childProps, eventKey, eventName) => {
    ...
    if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(eventReturn)) {
...
function getExternalMutationsWithChildren(mutations, baseProps, baseState, childNames) {
  ...
  return childNames.reduce((memo, childName) => {
    ...
    return lodash_pickBy__WEBPACK_IMPORTED_MODULE_1___default()(memo, v => !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(v));
  }, {});
}
...
function getExternalMutations(mutations, baseProps, baseState, childName) {
  ...
  return eventKeys.reduce((memo, eventKey) => {
    ...
    if (eventKey === "parent") {
      ...
      const targets = lodash_uniq__WEBPACK_IMPORTED_MODULE_3___default()(Object.keys(keyProps).concat(Object.keys(keyState)));
      memo[eventKey] = targets.reduce((m, target) => {
        ...
        return lodash_pickBy__WEBPACK_IMPORTED_MODULE_1___default()(m, v => !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(v));
      }, {});
    }
    return lodash_pickBy__WEBPACK_IMPORTED_MODULE_1___default()(memo, v => !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(v));
  }, {});
...
function getExternalMutation(mutations, baseProps, baseState, identifier) {
  ...
  if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(targetMutations)) {
    return undefined;
  }
  const keyMutations = targetMutations.filter(m => filterMutations(m, "eventKey"));
  if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(keyMutations)) {
    return undefined;
  }
...
const getGlobalEvents = events => lodash_pickBy__WEBPACK_IMPORTED_MODULE_1___default()(events, (_, key) => GLOBAL_EVENT_REGEX.test(key));
const omitGlobalEvents = events => lodash_omitBy__WEBPACK_IMPORTED_MODULE_2___default()(events, (_, key) => GLOBAL_EVENT_REGEX.test(key));
...
/* harmony import */ var lodash_uniqBy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash/uniqBy */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/uniqBy.js");
...
function getDataFromChildren(props, childComponents) {
  ...
  let stack = 0;
  const children = childComponents ? childComponents.slice(0) : react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(props.children);
  ...
  const iteratee = (child, childName, parent) => {
    ...
    if (!_data__WEBPACK_IMPORTED_MODULE_7__.isDataComponent(child)) {
      ...
      childElement = parent ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(child, parent.props) : child;
  ...
  const combine = (memo, val) => memo.concat(lodash_uniqBy__WEBPACK_IMPORTED_MODULE_4___default()(val, "_group"));
  ...
  return Object.values(lodash_groupBy__WEBPACK_IMPORTED_MODULE_3___default()(datasets, group));
}
function getData(props, childComponents) {
  if (props.data) {
    return _data__WEBPACK_IMPORTED_MODULE_7__.getData(props);
  }
  return getDataFromChildren(props, childComponents || react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(props.children));
}
...
function getChildStyle(child, index, calculatedProps, theme) {
  ...
  const dataStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, childStyle.data, Object.assign({}, dataWidth, style.data, defaultColor));
  const labelsStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, childStyle.labels, style.labels);
  return {
    ...childStyle,
    parent: style.parent,
    data: dataStyle,
...
const VICTORY_CURSOR_CONTAINER_DEFAULT_PROPS = {
  cursorLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__.VictoryLabel, null),
  cursorLabelOffset: {
    x: 5,
    y: -10
  },
  cursorComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_4__.LineSegment, null)
};
const useVictoryCursorContainer = initialProps => {
  ...
  const getPadding = () => {
    if (props.padding === undefined) {
      const child = Array.isArray(props.children) ? props.children.find(c => {
        return lodash_isObject__WEBPACK_IMPORTED_MODULE_2___default()(c.props) && c.props.padding !== undefined;
      }) : props.children;
      return victory_core__WEBPACK_IMPORTED_MODULE_5__.getPadding(child?.props);
    }
    return victory_core__WEBPACK_IMPORTED_MODULE_5__.getPadding(props.padding);
  };
  const getCursorElements = () => {
    ...
    if (cursorLabel) {
      ...
      newElements.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(cursorLabelComponent, lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, labelProps, {
    ...
    if (cursorDimension === "x" || cursorDimension === undefined) {
      newElements.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(cursorComponent, {
        key: `${name}-x-cursor`,
  ...
  return {
    props,
    children: [...react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(children), ...getCursorElements()]
  };
};
const VictoryCursorContainer = initialProps => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryContainer, props, children);
};
...
class SelectionHelpersClass {
  ...
  onMouseDown = (evt, targetProps) => {
    ...
    if (selectedData && victory_core__WEBPACK_IMPORTED_MODULE_4__.isFunction(targetProps.onSelectionCleared)) {
      targetProps.onSelectionCleared(lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, mutatedProps, targetProps));
    }
  ...
  onMouseMove = lodash_throttle__WEBPACK_IMPORTED_MODULE_1___default()(this.handleMouseMove, ON_MOUSE_MOVE_THROTTLE_MS, {
    leading: true,
    trailing: false
  });
  onMouseUp = (evt, targetProps) => {
    ...
    const callbackMutation = selectedData && victory_core__WEBPACK_IMPORTED_MODULE_4__.isFunction(targetProps.onSelection) ? targetProps.onSelection(selectedData, bounds, lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, mutatedProps, targetProps)) : {};
    const parentMutation = [{
      target: "parent",
      mutation: () => mutatedProps
    }];
...
const VICTORY_ZOOM_CONTAINER_DEFAULT_PROPS = {
  clipContainerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_2__.VictoryClipContainer, null),
  allowPan: true,
  allowZoom: true,
  zoomActive: false
};
const useVictoryZoomContainer = initialProps => {
  ...
  const modifiedChildren = react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(children).map(child => {
    ...
    const originalDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, props.originalDomain, props.domain);
    const zoomDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, props.zoomDomain, props.domain);
    const cachedZoomDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, props.cachedZoomDomain, props.domain);
    let domain;
    ...
    const newChild = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(child, lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(childProps, child.props));
    ...
    if (victory_core__WEBPACK_IMPORTED_MODULE_3__.isDataComponent(newChild)) {
      ...
      const groupComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(clipContainerComponent, {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(newChild, {
        groupComponent
      });
    }
    return newChild;
...
/* harmony import */ var lodash_defaults__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/defaults */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/defaults.js");
/* harmony import */ var lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_defaults__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lodash_delay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/delay */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/delay.js");
...
const RawZoomHelpers = {
  ...
  handleAnimation(ctx) {
    ...
    return lodash_delay__WEBPACK_IMPORTED_MODULE_2___default()(resumeAnimation, 16); // eslint-disable-line no-magic-numbers
  },
  ...
  getDomain(props) {
    ...
    const childComponents = react__WEBPACK_IMPORTED_MODULE_0__.Children.toArray(children);
    let childrenDomain = {};
...
const ZoomHelpers = {
  ...
  onMouseMove: lodash_throttle__WEBPACK_IMPORTED_MODULE_3___default()(RawZoomHelpers.onMouseMove.bind(RawZoomHelpers), 16,
  // eslint-disable-line no-magic-numbers
  {
    leading: true,
    trailing: false
  }),
  onWheel: lodash_throttle__WEBPACK_IMPORTED_MODULE_3___default()(RawZoomHelpers.onWheel.bind(RawZoomHelpers), 16,
  // eslint-disable-line no-magic-numbers
  {
    leading: true,
    trailing: false
